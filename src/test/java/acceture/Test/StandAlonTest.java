...
public class StandAlonTest {
	...
	WebElement prod = products.stream().filter(product -> product.findElement(By.cssSelector("b")).getText().equals(productName)).findFirst().orElse(null);
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#toast-container"))); // toast-container option visible
		...
		//Thread.sleep(2000);
		//WebElement checkoutButton = driver.findElement(By.cssSelector(".action__submit"));
		...
		//wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[contains(text(),'Place Order ')]")));
